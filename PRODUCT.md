...
The gig marketplace that makes informal work feel safe: escrow, verification, and a clear lifecycle turn a stranger's promise into a protected transaction — for one account that both earns and spends.

## Brand Personality

Warm and human first — Daala speaks like a person, not a bank or a corporation, and feels community-rooted rather than transactional. It is energetic and opportunity-driven: the vibrant orange carries momentum, hustle, and the promise of income and growth, balanced against a deep, grounded green that reads as trustworthy and safe with money. Underneath the warmth it is capable and modern — confident, fast, and on par with any global app, because the informal economy deserves software that treats it with dignity, not a stripped-down second-class tool. The through-line: friendly enough to feel like it's on your side, solid enough to trust with your money.

## Anti-references

Not cheap or low-trust classifieds. The failure mode to design away from is the Gumtree/OLX-style dense, spammy listing wall: endless undifferentiated rows, no sense of who is real, and nothing that makes handing over money feel safe. Daala earns trust visually — breathing room, clear status, verification and escrow surfaced — where classifieds broadcast risk.
...
No formal WCAG target is committed yet — ship sensible defaults now and formalise later. Given the audience (entry-level Android, ~2GB RAM, expensive data, varied literacy, frequent bright-daylight use), practical baselines still apply: legible contrast and type sizes, generous tap targets, plain language, and a data-light footprint. Treat these as product hygiene rather than a certified standard for now.
